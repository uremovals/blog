...
<div class="container mt-5">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
      ...
      <div class="tab-content" id="pills-tabContent">
        ...
        <img class="img-fluid" src="/images/what-we-do.jpg" lazy="loading" alt="what-we-do shuffleloot.com">
        </div>
        </div>
         </div>
        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
            <div class="row text-white">
                ...
                <div class="col-xl-6 order-1 order-xl-2">
                <img class="img-fluid" src="/images/how-is-works.jpg" lazy="loading" alt="what-is-works shuffleloot.com">
                </div>
                </div>
        </div>
        <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
            <div class="row text-white">
                ...
                <div class="col-xl-6 order-1 order-xl-2">
                <img class="img-fluid" src="/images/keep-visiting-us.jpg" lazy="loading" alt="keep-visiting-us shuffleloot.com">
                </div>
                </div>
        </div>
      </div>
...
<h2>Popular categories</h2>
    <div class="card-columns">
        ...
        <div class="card">
            <img class="card-img-top" src="/images/toys-children-and-baby.jpg" lazy="loading" alt="Toys children and baby.jpg">
            <div class="card-body">
              ...
              <p class="card-text"><ul class="list-unstyled">
                ...
                <div class="card">
                <img class="card-img-top" src="/images/electronics-and-computers.jpg" lazy="loading" alt="Electronics and computers">
                <div class="card-body">
                ...
                <div class="card">
                    <img class="card-img-top" src="/images/books-and-audible.jpg" lazy="loading" alt="Books and audible">
                    <div class="card-body">
                  ...
                  <div class="card">
                    <img class="card-img-top" src="/images/fashion-shoes-and-watches.jpg" lazy="loading" alt="Fashion shoes and watches">
                    <div class="card-body">
                    ...
                    <div class="card">
                      ...
                      <div class="card">
                        <img class="card-img-top" src="/images/car-and-motor.jpg" lazy="loading" alt="Car and motor">
                        <div class="card-body">
                      ...
                      <div class="card">
                        <img class="card-img-top" src="/images/food-and-grocery.jpg" lazy="loading" alt="Food and grocery">
                        <div class="card-body">
                      ...
                      <div class="card">
                        <img class="card-img-top" src="/images/home-garden-tools.jpg" lazy="loading" alt="Home garden and tools">
                        <div class="card-body">
                      ...
                      <div class="card">
                        <img class="card-img-top" src="/images/sports-and-outdoors.jpg" lazy="loading" alt="Sports-and-outdoors">
                        <div class="card-body">
                      ...
                      <div class="card">
                        <img class="card-img-top" src="/images/health-and-beauty.jpg" lazy="loading" alt="Health and beauty">
                        <div class="card-body">
                      ...
                      <div class="card">
                        <img class="card-img-top" src="/images/business-industrial-and-scientific.jpg" lazy="loading" alt="Business industrial and scientific">
                        <div class="card-body">
